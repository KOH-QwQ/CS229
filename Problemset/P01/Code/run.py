...
#          pred_path='../data/p01b_pred_1.txt')

#     p01b(train_path='../data/ds2_train.csv',
#          eval_path='../data/ds2_valid.csv',
#          pred_path='../data/p01b_pred_2.txt')

#     p01e(train_path='../data/ds1_train.csv',
#          eval_path='../data/ds1_valid.csv',
#          pred_path='../data/p01e_pred_1.txt')

#     p01e(train_path='../data/ds2_train.csv',
#          eval_path='../data/ds2_valid.csv',
#          pred_path='../data/p01e_pred_2.txt')
...
if args.p_num == 0 or args.p_num == 5:
    p05b(tau=10,
         train_path=r"C:\Users\17270\Desktop\cs229-2018-autumn-main\problem-sets\PS1\src\data\ds5_train.csv",
         eval_path=r"C:\Users\17270\Desktop\cs229-2018-autumn-main\problem-sets\PS1\src\data\ds5_valid.csv")
